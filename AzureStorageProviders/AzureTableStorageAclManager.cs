...
namespace ScrewTurn.Wiki.Plugins.AzureStorage {
	...
	/// </summary>
	public class AzureTableStorageAclManager : IAclManager {
		...
		public AzureTableStorageAclManager(StoreEntry storeEntry, DeleteEntries deleteEntries, RenameResource renameResource,

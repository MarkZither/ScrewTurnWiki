...
namespace ScrewTurn.Wiki.Plugins.AzureStorage {
	...
	public interface IIndexConnector {
		...
		void DeleteDataForDocument(IDocument document);
	...
	/// </summary>
	public delegate void ClearIndex();
	...
	/// <param name="keywords">The keywords.</param>
	/// <returns>The number of stored occurrences.</returns>
	public delegate int SaveDataForDocument(IDocument document, WordInfo[] content, WordInfo[] title, WordInfo[] keywords);

	/// <summary>
	/// Defines a delegate for a method for deleting a document's data.
	/// </summary>
	/// <param name="document">The document.</param>
	public delegate void DeleteDataForDocument(IDocument document);
	...
	public delegate bool TryFindWord(string text, out Word word);

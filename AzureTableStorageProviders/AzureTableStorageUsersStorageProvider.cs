...
namespace AzureTableStorageProviders {
	...
	public class AzureTableStorageUsersStorageProvider : IUsersStorageProviderV30 {
		...
		public void SetUp(IHostV30 host, string config) {
			...
			TableStorage.CreateTable(connectionStrings[0], connectionStrings[1], UsersTable);
			TableStorage.CreateTable(connectionStrings[0], connectionStrings[1], UserGroupsTable);
			TableStorage.CreateTable(connectionStrings[0], connectionStrings[1], UserDataTable);
		}

...
namespace ScrewTurn.Wiki.Models
{
	public class Device
	{
		/// <summary>
		...
		public bool IsMobile
		{
			get
			{
				return this._match["IsMobile"] != null ?
					this._match["IsMobile"].ToBool() :
					false;
			}
		}
		...
		public int ScreenPixelsHeight
		{
			get
			{
				return this._match["ScreenPixelsHeight"] != null ?
					(int)this._match["ScreenPixelsHeight"].ToDouble() :
					0;
			}
		}
		...
		public int ScreenPixelsWidth
		{
			get
			{
				return this._match["ScreenPixelsWidth"] != null ?
					(int)this._match["ScreenPixelsWidth"].ToDouble() :
					0;
			}
		}

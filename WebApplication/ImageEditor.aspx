		...
		<div id="ImageEditorMainDiv">
			...
			<div id="ResizeOptionsDiv">
				...
				<div id="PreviewLinkDiv">
					...
					<asp:Label ID="lblScale" runat="server" meta:resourcekey="lblScaleResource1"
					/><asp:Label
			...
			<div id="MainSaveDiv">
				...
				<div id="SaveDiv">
					<asp:CheckBox ID="chkNewName" runat="server" Text="Save as new file" ToolTip="If not selected, the original file is overwritten"
						Checked="True" OnCheckedChanged="chkNewName_CheckedChanged" meta:resourcekey="chkNewNameResource2" /><br />
					<asp:TextBox ID="txtNewName" runat="server" Width="224px" 
						meta:resourcekey="txtNewNameResource1" /><br />
					<asp:RadioButton ID="rdoPng" runat="server" Text="PNG" ToolTip="PNG format (alpha channel is preserved)"
						GroupName="format" OnCheckedChanged="rdoFormat_CheckedChanged" meta:resourcekey="rdoPngResource2" />
					<asp:RadioButton ID="rdoJpegHigh" runat="server" Text="JPEG 100%" ToolTip="JPEG format, full quality" 
						GroupName="format" OnCheckedChanged="rdoFormat_CheckedChanged" meta:resourcekey="rdoJpegHighResource2"  />
					<asp:RadioButton ID="rdoJpegMedium" runat="server" Text="JPEG 60%" ToolTip="JPEG format, medium quality" 
						GroupName="format" OnCheckedChanged="rdoFormat_CheckedChanged" meta:resourcekey="rdoJpegMediumResource2" />
				</div>
			</div>

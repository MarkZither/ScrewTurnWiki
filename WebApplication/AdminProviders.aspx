    ...
    <%@ Register TagPrefix="st" TagName="ProviderSelector" Src="~/ProviderSelector.ascx" %>
        ...
        <%@ Register assembly="Syncfusion.EJ.Web, Version=16.4460.0.42, Culture=neutral, PublicKeyToken=3d67ed1f87d44c89" namespace="Syncfusion.JavaScript.Web" tagprefix="ej" %>
            ...
            <asp:Content ID="ctnProviders" ContentPlaceHolderID="cphAdmin" runat="server">
                ...
                <h2 class="sectiontitle">
                    <asp:Literal ID="lblProviders" runat="server" Text="Providers" EnableViewState="False" meta:resourcekey="lblProvidersResource1" />
                </h2>
                ...
                <asp:Panel ID="pnlList" runat="server" meta:resourcekey="pnlListResource1">
                    ...
                    <div id="ProvidersListContainerDiv">
                        <asp:Repeater ID="rptProviders" runat="server" OnDataBinding="rptProviders_DataBinding" OnItemCommand="rptProviders_ItemCommand">
                            <HeaderTemplate>
                                <table cellpadding="0" cellspacing="0" class="generic">
                                    <thead>
                                        <tr class="tableheader">
                                            <th>
                                                <asp:Literal ID="lblName" runat="server" EnableViewState="False" meta:resourcekey="lblNameResource1" Text="Name" />
                                            </th>
                                            <th>
                                                <asp:Literal ID="lblVersion" runat="server" EnableViewState="False" meta:resourcekey="lblVersionResource1" Text="Ver." />
                                            </th>
                                            <th>
                                                <asp:Literal ID="lblAuthor" runat="server" EnableViewState="False" meta:resourcekey="lblAuthorResource1" Text="Author" />
                                            </th>
                                            <th>
                                                <asp:Literal ID="lblUpdateStatus" runat="server" EnableViewState="false" meta:resourcekey="lblUpdateStatusResource1" Text="Update Status" />
                                            </th>
                                            <th>&nbsp;</th>
                                        </tr>
                                    </thead>
                            ...
                            <ItemTemplate>
                                <tr class='tablerow<%# Eval("AdditionalClass") %>'>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="btnSelect" runat="server" CommandArgument='<%# Eval("TypeName") %>' CommandName="Select" meta:resourcekey="btnSelectResource2" Text="Select" />
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <AlternatingItemTemplate>
                                <tr class='tablerowalternate<%# Eval("AdditionalClass") %>'>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="btnSelect" runat="server" Text="Select" CommandName="Select" CommandArgument='<%# Eval("TypeName") %>' meta:resourcekey="btnSelectResource1" />
                                    </td>
                                </tr>
                            </AlternatingItemTemplate>
                            <FooterTemplate>
                    ...
                    <asp:Panel ID="pnlProviderDetails" runat="server" Visible="False" meta:resourcekey="pnlProviderDetailsResource1">
                        <div id="EditProviderDiv">
                            <h3>
                                <asp:Literal ID="lblProviderName" runat="server" meta:resourcekey="lblProviderNameResource1" />
                            </h3>
                            ...
                            <a href="#" onclick="javascript:document.getElementById('ProviderConfigHelpDiv').style['display'] = ''; return false;">
                                <asp:Literal ID="lblConfigHelp" runat="server" Text="Help" EnableViewState="False" meta:resourcekey="lblConfigHelpResource1" />
                            </a>
                            <br />
                            ...
                            <br /><br />
                            <asp:Label ID="lblCannotDisable" runat="server" CssClass="small" Text="Cannot disable the provider because it is the default provider or,<br />in case of a Pages Provider, it manages the default page of the root namespace" meta:resourcekey="lblCannotDisableResource1"
                            /><br />
                    ...
                    <div id="ProvidersUpdateDiv">
                        ...
                        <asp:Button ID="btnAutoUpdateProviders" runat="server" Text="Auto-update Providers" ToolTip="Automatically update all installed providers, of all types" OnClientClick="__ShowUpdateProgress" OnClick="btnAutoUpdateProviders_Click" meta:resourcekey="btnAutoUpdateProvidersResource1"
                        />
                ...
                <br />
                <h2 class="separator">
                    <asp:Literal ID="lblDefaultProvidersTitle" runat="server" Text="Default Providers" EnableViewState="False" meta:resourcekey="lblDefaultProvidersTitleResource1" />
                </h2>
                ...
                <br />
                <h2 class="separator">
                    <asp:Literal ID="lblUploadProvidersTitle" runat="server" Text="Providers DLLs Management" EnableViewState="False" meta:resourcekey="lblUploadProvidersTitleResource1" />
                </h2>

                <h4>
                    <asp:Literal ID="lblUploadNewDllEj" runat="server" Text="Upload new DLL" EnableViewState="False" meta:resourcekey="lblUploadNewDllResource1" />
                </h4>
                <div>
                ...
                <h4>
                    <asp:Literal ID="lblUploadNewDll" runat="server" Text="Upload new DLL" EnableViewState="False" meta:resourcekey="lblUploadNewDllResource1" />
                </h4>
                <asp:FileUpload ID="upDll" runat="server" AutoUpdateAfterCallBack="True" meta:resourcekey="upDllResource1" />
                <asp:Button ID="btnUpload" runat="server" Text="Upload" OnClick="btnUpload_Click" EnabledDuringCallBack="False" PreCallBackFunction="__ShowUploadProgress" PostCallBackFunction="__HideUploadProgress" meta:resourcekey="btnUploadResource1" />
			...
			<asp:Literal ID="lblUploadInfo" runat="server" EnableViewState="False"
                ...
                <br />
                <h2 class="separator">
                    <asp:Literal ID="lblDataMigration" runat="server" Text="Data Migration" EnableViewState="False" meta:resourcekey="lblDataMigrationResource1" />
                </h2>
                <asp:Literal ID="lblMigrationInfo" runat="server" EnableViewState="False" Text="<b>Note 1</b>: always perform a full backup of all your data before performing a migration.<br /><b>Note 2</b>: migrations usually take several minutes to complete: during this time, do not perform any other activity in the wiki, and do not close this page.<br /><b>Note 3</b>: the destination provider should be completely empty: if it contains any data, it might cause consistency issues. Refer to the target provider's documentation for details.<br /><b>Timeouts</b>: it is strongly suggested that you increase the executionTimeout parameter in web.config before migrating data."
                    meta:resourcekey="lblMigrationInfoResource2" />
                <br /><br />

                <h4>
                    <asp:Literal ID="lblMigratePages" runat="server" Text="Migrate Pages and related data" EnableViewState="False" meta:resourcekey="lblMigratePagesResource1" />
                </h4>
                <asp:DropDownList ID="lstPagesSource" runat="server" AutoPostBack="true" AutoUpdateAfterCallBack="True" OnSelectedIndexChanged="lstPagesSource_SelectedIndexChanged" meta:resourcekey="lstPagesSourceResource1" />
                ...
                <asp:Button ID="btnMigratePages" runat="server" Text="Migrate" Enabled="False" EnabledDuringCallBack="False" AutoUpdateAfterCallBack="True" OnClientClick="RequestConfirm" OnClick="btnMigratePages_Click" meta:resourcekey="btnMigratePagesResource1" />
                ...
                <h4>
                    <asp:Literal ID="lblMigrateUsers" runat="server" Text="Migrate Users and related data" EnableViewState="False" meta:resourcekey="lblMigrateUsersResource1" />
                </h4>
                <asp:DropDownList ID="lstUsersSource" runat="server" AutoPostBack="true" AutoUpdateAfterCallBack="True" OnSelectedIndexChanged="lstUsersSource_SelectedIndexChanged" meta:resourcekey="lstUsersSourceResource1" />
                <img src="Images/ArrowRight.png" alt="->" />
                ...
                <asp:Button ID="btnMigrateUsers" runat="server" Text="Migrate" Enabled="False" EnabledDuringCallBack="False" AutoUpdateAfterCallBack="True" OnClientClick="RequestConfirm" OnClick="btnMigrateUsers_Click" meta:resourcekey="btnMigrateUsersResource1" />
		...
		<asp:Literal ID="lblMigrateUsersInfo" runat="server" 
			...
			EnableViewState="False" meta:resourcekey="lblMigrateUsersInfoResource1" />
                ...
                <h4>
                    <asp:Literal ID="lblMigrateFiles" runat="server" Text="Migrate Files and related data" EnableViewState="False" meta:resourcekey="lblMigrateFilesResource1" />
                </h4>
                <asp:DropDownList ID="lstFilesSource" runat="server" AutoPostBack="true" AutoUpdateAfterCallBack="True" OnSelectedIndexChanged="lstFilesSource_SelectedIndexChanged" meta:resourcekey="lstFilesSourceResource1" />
                <img src="Images/ArrowRight.png" alt="->" />
                ...
                <asp:Button ID="btnMigrateFiles" runat="server" Text="Migrate" Enabled="False" EnabledDuringCallBack="False" AutoUpdateAfterCallBack="True" OnClientClick="RequestConfirm" OnClick="btnMigrateFiles_Click" meta:resourcekey="btnMigrateFilesResource1" />
                ...
                <h4>
                    <asp:Literal ID="lblCopySettings" runat="server" Text="Copy Settings and related data" EnableViewState="False" meta:resourcekey="lblCopySettingsResource1" />
                </h4>
                <asp:Label ID="lblSettingsSource" runat="server" AutoUpdateAfterCallBack="True" meta:resourcekey="lblSettingsSourceResource1" />
                <img src="Images/ArrowRight.png" alt="->" />
                <asp:DropDownList ID="lstSettingsDestination" runat="server" AutoUpdateAfterCallBack="True" AutoPostBack="True" OnSelectedIndexChanged="lstSettingsDestination_SelectedIndexChanged" meta:resourcekey="lstSettingsDestinationResource1" />
                <asp:Button ID="btnCopySettings" runat="server" Text="Copy" Enabled="False" EnabledDuringCallBack="False" AutoUpdateAfterCallBack="True" OnClientClick="RequestConfirm" OnClick="btnCopySettings_Click" meta:resourcekey="btnCopySettingsResource1" />

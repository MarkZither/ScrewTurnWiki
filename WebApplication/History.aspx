	...
	<asp:Repeater ID="rptHistory" runat="server" OnItemCommand="rptHistory_ItemCommand">
		...
		<ItemTemplate>
			<tr class="tablerow">
				...
				<td><a href='<%# ScrewTurn.Wiki.UrlTools.BuildUrl((string)Eval("Wiki"), "History.aspx?Page=", ScrewTurn.Wiki.Tools.UrlEncode((string)Eval("Page")), "&amp;Revision=", (string)Eval("Revision")) %>'><%# Eval("Title") %></a></td>
				<td><%# Eval("SavedOn") %></td>
				<td><%# Eval("SavedBy") %></td>
				<td><%# Eval("Comment") %></td>

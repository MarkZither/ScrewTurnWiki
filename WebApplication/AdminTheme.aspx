...
<asp:Content ID="ctnThemes" ContentPlaceHolderID="cphAdmin" runat="server">
	...
	<asp:DropDownList ID="lstProvThemeSelectorUpload" runat="server" meta:resourcekey="provThemeSelectorResource1" CssClass="storageproviderselector" AutoPostBack="true"/><br />

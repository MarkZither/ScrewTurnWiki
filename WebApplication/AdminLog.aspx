...
<asp:Content ID="ctnLog" ContentPlaceHolderID="cphAdmin" runat="server">
	...
	<div id="LogControlsDiv">
		...
		<asp:CheckBox ID="chkWarnings" runat="server" Text="Warnings" Checked="True" 
			AutoPostBack="true" OnCheckedChanged="chkFilter_CheckedChanged" meta:resourcekey="chkWarningsResource1" />
		<asp:CheckBox ID="chkErrors" runat="server" Text="Errors" Checked="True" 
			AutoPostBack="true" OnCheckedChanged="chkFilter_CheckedChanged" meta:resourcekey="chkErrorsResource1" />
		
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<asp:Label ID="lblLimit" runat="server" Text="Currently displaying only 100 log entries &mdash;" AutoUpdateAfterCallBack="true"

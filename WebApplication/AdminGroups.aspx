	...
	<div class="leftaligned">
		...
		<asp:Panel ID="pnlList" runat="server" meta:resourcekey="pnlListResource1" >
			...
			<div class="ButtonsDiv">
				<asp:Button ID="btnNewGroup" runat="server" Text="New Group" ToolTip="Create a new User Group" OnClick="btnNewGroup_Click" meta:resourcekey="btnNewGroupResource1" />
			</div>
		
		</asp:Panel>

		<asp:Panel ID="pnlEditGroup" runat="server" Visible="False" meta:resourcekey="pnlEditGroupResource1">
			<div id="EditGroupDiv">

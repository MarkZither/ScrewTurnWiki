	...
	<div class="leftaligned">
		...
		<asp:Panel ID="pnlList" runat="server" meta:resourcekey="pnlListResource1">
			...
			<div class="ButtonsDiv">
				<asp:Button ID="btnNewTemplate" runat="server" Text="New Template" OnClick="btnNewTemplate_Click" meta:resourcekey="btnNewTemplateResource1" />
				<asp:Button ID="btnNewSnippet" runat="server" Text="New Snippet" OnClick="btnNewSnippet_Click" meta:resourcekey="btnNewSnippetResource1" />
			</div>
		</asp:Panel>

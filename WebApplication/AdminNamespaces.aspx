	...
	<div class="leftaligned">
		...
		<asp:Panel ID="pnlList" runat="server"  meta:resourcekey="pnlListResource1" >
			...
			<div class="ButtonsDiv">
				<asp:Button ID="btnNewNamespace" runat="server" Text="New Namespace" CssClass="block" ToolTip="Create a new Namespace" OnClick="btnNewNamespace_Click" meta:resourcekey="btnNewNamespaceResource1" />
			</div>
		</asp:Panel>
	
		<asp:Panel ID="pnlEditNamespace" runat="server"  Visible="False" meta:resourcekey="pnlEditNamespaceResource1" >

...
<asp:Content ID="ctnNavPaths" ContentPlaceHolderID="cphAdmin" runat="server">
	...
	<asp:Panel ID="pnlList" runat="server"  meta:resourcekey="pnlListResource1" >
		<asp:Button ID="btnNewNavPath" runat="server" Text="New Nav. Path" ToolTip="Create a new Navigation Path" CssClass="rightaligned" OnClick="btnNewNavPath_Click" 
	...
	<asp:Panel ID="pnlEditNavPath" runat="server"  

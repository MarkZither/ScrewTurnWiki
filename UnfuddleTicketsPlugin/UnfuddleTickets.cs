...
namespace ScrewTurn.Wiki.Plugins.PluginPack {
	...
	public class UnfuddleTickets : IFormatterProviderV40 {
		...
		private static readonly ComponentInformation Info = new ComponentInformation("Unfuddle Tickets Plugin", "Threeplicate Srl", "4.0.5.143", "http://www.screwturn.eu", "http://www.screwturn.eu/Version4.0/PluginPack/UnfuddleTickets.txt");

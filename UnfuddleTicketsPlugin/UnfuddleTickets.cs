...
namespace ScrewTurn.Wiki.Plugins.PluginPack {
	...
	public class UnfuddleTickets : IFormatterProviderV30 {
		...
		private static readonly ComponentInformation Info = new ComponentInformation("Unfuddle Tickets Plugin", "Threeplicate Srl", "3.0.2.538", "https://github.com/MarkZither/ScrewTurnWiki/tree/gh-pages", "http://www.screwturn.eu/Version/PluginPack/UnfuddleTickets2.txt");

...
namespace ScrewTurn.Wiki.Plugins.SqlServer {
	...
	public class SqlServerSettingsStorageProvider : SqlSettingsStorageProviderBase {
		...
		private readonly ComponentInformation info = new ComponentInformation("MySQL Settings Storage Provider", "Threeplicate Srl", "3.0.1.471", "http://www.screwturn.eu", "http://www.screwturn.eu/Version/SQLServerProv/Settings.txt");

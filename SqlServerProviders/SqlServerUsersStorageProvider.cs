...
namespace ScrewTurn.Wiki.Plugins.SqlServer {
	...
	public class SqlServerUsersStorageProvider : SqlUsersStorageProviderBase, IUsersStorageProviderV40 {
		...
		private readonly ComponentInformation info = new ComponentInformation("SQL Server Users Storage Provider", "Threeplicate Srl", "4.0.5.143", "http://www.screwturn.eu", null);

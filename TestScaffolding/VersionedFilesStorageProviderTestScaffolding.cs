...
namespace ScrewTurn.Wiki.Tests {
	...
	[TestFixture]
	public abstract class VersionedFilesStorageProviderTestScaffolding {

		private MockRepository mocks = new MockRepository();
		protected internal string testDir = Path.Combine(Environment.GetEnvironmentVariable("TEMP"), Guid.NewGuid().ToString());
		...
		protected IVersionedFilesStorageProviderV30 MockVersionedFilesProvider() {
			IVersionedFilesStorageProviderV30 prov = mocks.DynamicMock<IVersionedFilesStorageProviderV30>();
		...
		public abstract IVersionedFilesStorageProviderV30 GetProvider();
		public abstract IVersionedFilesStorageProviderV30 SetupProvider();
		...
		[Test]
		public void Init_InvalidYAMLConfig()
		{
			string illegalYAML = 
@"channels:
-name: '#mychannel'
...
password: 'mypassword'";
			...
			{
				prov.Init(MockHost(), illegalYAML);
			}, "sweyugij", null);
		}

		[Test]
		public void Init_TwoRepoConfig()
		{
			string repoUrl = "https://ZITHERLDWX01.ad.mark-burton.com:8443/svn/TestWiki/";
			string repoUrl2 = "https://ZITHERLDWX01.ad.mark-burton.com:8443/svn/TestWiki2/";
			...
			if(isAppveyor)
			{
				...
				repoUrl2 = "https://svn.riouxsvn.com/markburtonwiki2";
			}
			string config =
$@"--- 
Repos: 
  ...
  - 
    ...
    Username: 'wiki'";
			...
			Assert.IsNotNull(prov.CountRepos());
			Assert.AreEqual(2, prov.CountRepos());
		}

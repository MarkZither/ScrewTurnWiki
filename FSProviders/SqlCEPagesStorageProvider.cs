...
namespace ScrewTurn.Wiki.Plugins.FSProviders {
	...
	public class SqlCEPagesStorageProvider : SqlPagesStorageProviderBase, IPagesStorageProviderV40 {
		...
		private readonly ComponentInformation info = new ComponentInformation("SQL CE Pages Storage Provider", "Threeplicate Srl", "4.0.5.143", "http://www.screwturn.eu", null);

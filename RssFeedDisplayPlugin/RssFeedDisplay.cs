...
namespace ScrewTurn.Wiki.Plugins.PluginPack {
	...
	public class RssFeedDisplay : IFormatterProviderV40 {
		...
		private static readonly ComponentInformation Info = new ComponentInformation("RSS Feed Display Plugin", "Threeplicate Srl", "4.0.5.143", "http://www.screwturn.eu", "http://www.screwturn.eu/Version4.0/PluginPack/RssFeedDisplay.txt");
